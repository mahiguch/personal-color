...
def create_face_image(skin_tone, hair_color, eye_color, title, filename, size=(512, 512)):
    ...
    draw.ellipse([face_left, face_top, face_right, face_bottom], fill=skin_tone, outline='#d0d0d0', width=2)
    
    # 髪（上部）
    hair_top = face_top - 60
    hair_bottom = face_top + 40
    draw.ellipse([face_left - 20, hair_top, face_right + 20, hair_bottom], fill=hair_color)
    ...
    draw.ellipse([left_eye_x - eye_width//2, eye_y - eye_height//2, 
                  left_eye_x + eye_width//2, eye_y + eye_height//2], fill='white')
    ...
    draw.ellipse([right_eye_x - eye_width//2, eye_y - eye_height//2, 
                  right_eye_x + eye_width//2, eye_y + eye_height//2], fill='white')
    draw.ellipse([right_eye_x - 8, eye_y - 8, right_eye_x + 8, eye_y + 8], fill=eye_color)
    draw.ellipse([right_eye_x - 4, eye_y - 4, right_eye_x + 4, eye_y + 4], fill='black')
    
    # 眉毛
    brow_y = eye_y - 20
    draw.ellipse([left_eye_x - 15, brow_y - 3, left_eye_x + 15, brow_y + 3], fill='#654321')
    draw.ellipse([right_eye_x - 15, brow_y - 3, right_eye_x + 15, brow_y + 3], fill='#654321')
    
    # 鼻
    nose_y = center_y + 10
    draw.ellipse([center_x - 8, nose_y - 5, center_x + 8, nose_y + 5], fill=skin_tone, outline='#c0c0c0')
    
    # 口
    mouth_y = center_y + 50
    draw.ellipse([center_x - 20, mouth_y - 8, center_x + 20, mouth_y + 8], fill='#ff9999')
    ...
    # 左頬
    draw.ellipse([center_x - 70, center_y + 10, center_x - 40, center_y + 40], fill=cheek_color)
    # 右頬
    draw.ellipse([center_x + 40, center_y + 10, center_x + 70, center_y + 40], fill=cheek_color)
...
def create_no_face_landscape(filename, size=(512, 512)):
    ...
    draw.ellipse([sun_x-25, sun_y-25, sun_x+25, sun_y+25], fill='#FFD700')  # ゴールド
    ...
    draw.rectangle([tree_x-8, tree_y-80, tree_x+8, tree_y], fill='#8B4513')  # サドルブラウン
    draw.ellipse([tree_x-25, tree_y-100, tree_x+25, tree_y-40], fill='#228B22')  # フォレストグリーン
